...
// const RogProfile = () => Widget.Stack({
//   transition: 'slide_up_down',
//   transitionDuration: userOptions.animations.durationSmall,
//   children: {
//     'performance': Widget.Label({ className: 'txt-norm', label: 'P' }),
//     'balanced': Widget.Label({ className: 'txt-norm', label: 'B' }),
//     'Quiet': Widget.Label({ className: 'txt-norm', label: 'Q' }),
//   },
//   setup: (self) => self.poll(5000, (stack) => {
//     const profile = Utils.exec('bash -c powerprofilesctl get')
//     stack.shown = profile
//   })
// })

...
hl.bind("SUPER + G", hl.dsp.workspace.toggle_special("deepseek"), {description = "Deepseek"} )
hl.bind("SUPER + SHIFT + G", hl.dsp.workspace.toggle_special("chatgpt"), {description = "ChatGPT"} )
...
hl.bind("SUPER + SHIFT + 1", hl.dsp.exec_cmd("~/.config/hypr/hyprland/scripts/workspace_action.sh movetoworkspace 1") ) -- # [hidden]
hl.bind("SUPER + SHIFT + 2", hl.dsp.exec_cmd("~/.config/hypr/hyprland/scripts/workspace_action.sh movetoworkspace 2") ) -- # [hidden]
hl.bind("SUPER + SHIFT + 3", hl.dsp.exec_cmd("~/.config/hypr/hyprland/scripts/workspace_action.sh movetoworkspace 3") ) -- # [hidden]
hl.bind("SUPER + SHIFT + 4", hl.dsp.exec_cmd("~/.config/hypr/hyprland/scripts/workspace_action.sh movetoworkspace 4") ) -- # [hidden]
hl.bind("SUPER + SHIFT + 5", hl.dsp.exec_cmd("~/.config/hypr/hyprland/scripts/workspace_action.sh movetoworkspace 5") ) -- # [hidden]
hl.bind("SUPER + SHIFT + 6", hl.dsp.exec_cmd("~/.config/hypr/hyprland/scripts/workspace_action.sh movetoworkspace 6") ) -- # [hidden]
hl.bind("SUPER + SHIFT + 7", hl.dsp.exec_cmd("~/.config/hypr/hyprland/scripts/workspace_action.sh movetoworkspace 7") ) -- # [hidden]
hl.bind("SUPER + SHIFT + 8", hl.dsp.exec_cmd("~/.config/hypr/hyprland/scripts/workspace_action.sh movetoworkspace 8") ) -- # [hidden]
hl.bind("SUPER + SHIFT + 9", hl.dsp.exec_cmd("~/.config/hypr/hyprland/scripts/workspace_action.sh movetoworkspace 9") ) -- # [hidden]
hl.bind("SUPER + SHIFT + 0", hl.dsp.exec_cmd("~/.config/hypr/hyprland/scripts/workspace_action.sh movetoworkspace 10") ) -- # [hidden]
...
hl.define_submap("macroworkspace", function()
    hl.bind("1", hl.dsp.focus({workspace = 1}) ) -- # [hidden]
    hl.bind("2", hl.dsp.focus({workspace = 11}) ) -- # [hidden]
    hl.bind("3", hl.dsp.focus({workspace = 21}) ) -- # [hidden]
    hl.bind("4", hl.dsp.focus({workspace = 31}) ) -- # [hidden]
    hl.bind("5", hl.dsp.focus({workspace = 41}) ) -- # [hidden]
    hl.bind("6", hl.dsp.focus({workspace = 51}) ) -- # [hidden]
    hl.bind("7", hl.dsp.focus({workspace = 61}) ) -- # [hidden]
    hl.bind("8", hl.dsp.focus({workspace = 71}) ) -- # [hidden]
    hl.bind("9", hl.dsp.focus({workspace = 81}) ) -- # [hidden]
    hl.bind("0", hl.dsp.focus({workspace = 91}) ) -- # [hidden]
    hl.bind("SHIFT + 1", hl.dsp.window.move({workspace = 1}) ) -- # [hidden]
    hl.bind("SHIFT + 2", hl.dsp.window.move({workspace = 11}) ) -- # [hidden]
    hl.bind("SHIFT + 3", hl.dsp.window.move({workspace = 21}) ) -- # [hidden]
    hl.bind("SHIFT + 4", hl.dsp.window.move({workspace = 31}) ) -- # [hidden]
    hl.bind("SHIFT + 5", hl.dsp.window.move({workspace = 41}) ) -- # [hidden]
    hl.bind("SHIFT + 6", hl.dsp.window.move({workspace = 51}) ) -- # [hidden]
    hl.bind("SHIFT + 7", hl.dsp.window.move({workspace = 61}) ) -- # [hidden]
    hl.bind("SHIFT + 8", hl.dsp.window.move({workspace = 71}) ) -- # [hidden]
    hl.bind("SHIFT + 9", hl.dsp.window.move({workspace = 81}) ) -- # [hidden]
    hl.bind("SHIFT + 0", hl.dsp.window.move({workspace = 91}) ) -- # [hidden]
    hl.bind("Escape", hl.dsp.exec_cmd([[notify-send "Exited"]]) ) -- # [hidden]
    hl.bind("CTRL + ALT + W", hl.dsp.exec_cmd([[notify-send "Exited"]]) ) -- # [hidden]
    hl.bind("Escape", hl.dsp.submap("reset") ) -- # [hidden]
    hl.bind("CTRL + ALT + W", hl.dsp.submap("reset") ) -- # [hidden]
end)
